...
// Payload size (1 - 32)
#define NRF905_PAYLOAD_SIZE	8 //NRF905_MAX_PAYLOAD
...
#define NRF905_TRX_EN	21	// Enable/standby pin (Required)
#define NRF905_PWR_MODE	5	// Power mode pin (Required)
#define NRF905_TX_EN	22	// TX / RX mode pin (Required)
...
#define NRF905_CSN		16	// SPI slave select pin (Required)
